{{-- resources/views/lecturer/profile/password.blade.php --}}
@extends('layouts.app')
...
<div class="space-y-6">
            ...
            <div class="w-20 h-20 rounded-3xl bg-white/10 flex items-center justify-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path stroke-linecap="round"
                          ...
                          stroke-width="2"
                          d="M12 11c0 .552-.448 1-1 1s-1-.448-1-1
                          .448-1 1-1 1 .448 1 1zm0
                          0v2m-6 4h12a2 2 0 002-2V9a2
                          2 0 00-2-2h-1V5a5 5 0
                          00-10 0v2H6a2 2 0 00-2
                          2v6a2 2 0 002 2z"/>
                </svg>
    ...
    <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('student.setprofilestudent') }}"
              method="POST"
              class="p-6 space-y-6">
