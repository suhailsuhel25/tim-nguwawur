{{-- resources/views/student/profilestudent.blade.php --}}
@extends('layouts.app')

@section('title', 'Profile Mahasiswa - Simagang')
...
<div class="space-y-6">
            ...
            <div class="flex-1">
                ...
                @if(Auth::user()->student)
                    <p class="text-slate-400 text-sm mt-1">
                        {{ Auth::user()->student->study_program }} &mdash; Angkatan {{ Auth::user()->student->cohort_year }}
                    </p>
                @endif
    ...
    <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('student.profilestudent.update') }}"
              method="POST"
              class="p-6 space-y-6">
