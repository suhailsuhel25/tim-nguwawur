...
<body class="flex min-h-screen bg-slate-50 antialiased">
    ...
    <div class="hidden lg:flex w-1/2 bg-primary text-white flex-col justify-center p-16 relative overflow-hidden">
        ...
        <div
            class="absolute inset-0 opacity-10 bg-[url('https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2670&auto=format&fit=crop')] bg-cover bg-center blend-overlay">
        </div>
        ...
        <div class="z-10 max-w-lg">
            ...
            <div class="flex gap-6">
                <div class="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 flex-1">
                    <!-- CheckCircle2 SVG -->
                    <svg class="text-blue-200 mb-3 w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <form method="POST" action="/login">
                ...
                <div class="mb-5">
                    <label class="block text-xs font-semibold text-slate-500 mb-2 uppercase tracking-wide">
                        IDENTIFICATION NUMBER <span
                            x-text="role === 'Mahasiswa' ? '(NIM)' : role === 'Dosen' ? '(NIP)' : '(ID)'"></span>
                    </label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <!-- IdCard SVG -->
                            <svg class="text-slate-400 w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg" width="24"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword"
                            ...
                            <!-- Eye/EyeOff SVG -->
                            <svg x-show="!showPassword" class="w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg"
                ...
                <button type="submit"
                    ...
                    <span class="flex items-center">
                        Sign In to Portal
                        <!-- ArrowRight SVG -->
                        <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
