...
@section('title', 'Tambah Periode Magang - Simagang')
@section('header_title', 'Tambah Periode Magang')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-bold text-slate-800">Tambah Periode Magang</h2>
            <p class="text-sm text-slate-500">Buat periode baru untuk pelaksanaan magang/PKL.</p>
        </div>
    </div>

    {{-- Form Card --}}
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <form action="{{ route('admin.periods.store') }}" method="POST" id="form-create-period">
            @csrf
            ...
            <div class="flex items-center gap-3 mt-8 pt-4 border-t border-slate-100">
                <button type="submit" id="btn-simpan-periode"
