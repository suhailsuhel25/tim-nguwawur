...
@section('title', 'Tambah Perusahaan - Simagang')
@section('header_title', 'Tambah Perusahaan')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-bold text-slate-800">Tambah Perusahaan Mitra</h2>
            <p class="text-sm text-slate-500">Daftarkan perusahaan mitra baru pada sistem.</p>
        </div>
    </div>

    {{-- Form Card --}}
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <form action="{{ route('admin.companies.store') }}" method="POST" id="form-create-company">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="industry" id="industry"
                               value="{{ old('industry') }}"
                               placeholder="Contoh: Teknologi Informasi, Manufaktur, Perbankan"
                               class="w-full px-3 py-2 border rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3"
                                  ...
                                  class="w-full px-3 py-2 border rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary resize-none
                                         {{ $errors->has('address') ? 'border-red-400 bg-red-50' : 'border-slate-200' }}">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_person" id="contact_person"
                               ...
                               placeholder="Nama PIC / HRD perusahaan"
                               class="w-full px-3 py-2 border rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_phone" id="contact_phone"
                                   ...
                                   placeholder="021-1234567 atau 081234567890"
            ...
            <div class="flex items-center gap-3 pt-2 border-t border-slate-100">
                <button type="submit" id="btn-simpan-perusahaan"
